...
// При помощи многомерного php массива  вам необходимо заполнить таблицу следующими данными:
// Для заголовков таблицы используйте следующие данные: No,  ФИО, E -mail, Пол, Год рождения
